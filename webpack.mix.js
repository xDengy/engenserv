...
mix.js('resources/js/app.js', 'public/js')
    ...
    .js('resources/js/cartAddPopup.js', 'public/js')
    .js('resources/js/formSuccess.js', 'public/js')
    ...
    .styles('resources/css/cartAddPopup.css', 'public/css/cartAddPopup.css')
    .styles('resources/css/formSuccess.css', 'public/css/formSuccess.css')
